(function (factory, window) {
  ...
  L.Control.Ruler = L.Control.extend({
    ...
    _moving: function (e) {
      if (this._clickedLatLong) {
        ...
        if (this._clickCount > 1) {
          ...
          text = '<br>' + '<b>' + this.options.angleUnit.label + '</b>&nbsp;' + this._result.Bearing.toFixed(this.options.angleUnit.decimal) + '&nbsp;' + this.options.angleUnit.display + '<br><b>' + this.options.lengthUnit.label + '</b>&nbsp;' + this._result.Distance.toFixed(this.options.lengthUnit.decimal) + '&nbsp;' + this.options.lengthUnit.display;
        }
    ...
    _calculateBearingAndDistance: function () {
      ...
      var distance = R * c;
      this._result = {
        Lat: this._clickedLatLong.lat,
        Lng: this._clickedLatLong.lng,
        Bearing: brng,
        Distance: distance
      };
    },
